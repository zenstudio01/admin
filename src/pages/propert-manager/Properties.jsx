...
export default function Properties() {
  ...
  const handleAddProperty = async (e) => {
    ...
    try {
      ...
      const response = await api.post("/property_create/", formData, {
        headers: {
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 text-white px-5 py-2.5 rounded-xl font-medium transition-all shadow-xs hover:opacity-90 text-sm self-start sm:self-center"
        ...
        <div className="bg-white rounded-xl border border-gray-100 shadow-xs p-4 mb-6 flex flex-col md:flex-row gap-4 items-center justify-between">
          ...
          <button className="flex items-center gap-2 px-4 py-2 text-sm text-slate-700 border border-gray-200 rounded-lg hover:bg-gray-50 transition w-full md:w-auto justify-center font-medium">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
            {filteredProperties.map((property) => {
              ...
              return (
                <div 
                  key={property.id}
                  className="bg-white rounded-2xl border border-gray-100 shadow-xs hover:shadow-md transition-all flex flex-col overflow-hidden group"
                >
                  {/* Card Header Content Banner */}
                  <div 
                    className="p-5 border-b border-gray-50 relative"
                    style={{ backgroundColor: `${Colors.primary}08` }}
                  >
                    <span 
                      className="absolute top-4 right-4 bg-white font-semibold text-xs px-2.5 py-1 rounded-full border border-gray-100 shadow-2xs"
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h3 className="font-bold text-slate-900 group-hover:text-opacity-80 transition-colors">{property.name}</h3>
                  ...
                  <div className="p-5 flex-1 space-y-4">
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      <div className="bg-gray-50/50 p-3 rounded-xl border border-gray-100/50">
                        ...
                        <p className="font-bold text-lg text-slate-900 mt-0.5">{property.total_units}</p>
                      </div>
                      <div className="bg-gray-50/50 p-3 rounded-xl border border-gray-100/50">
                        <p className="text-xs text-gray-400 flex items-center gap-1"><Users size={12} /> Occupied</p>
                        <p className="font-bold text-lg text-slate-900 mt-0.5">{property.occupied_units}</p>
                      </div>
                    </div>
                    ...
                    <div>
                      <div className="flex justify-between text-xs font-semibold mb-1.5">
                        ...
                        <span style={{ color: Colors.primary }}>{occupancyRate}%</span>
                      </div>
                    ...
                    <div className="pt-3 border-t border-gray-100 flex items-center justify-between text-sm">
                      <div>
                        ...
                        <p className="font-bold text-slate-900 text-base mt-0.5">{property.monthly_rent}</p>
                      </div>
                      <button 
                        className="flex items-center gap-1 font-semibold text-xs px-3 py-1.5 rounded-lg group/btn transition-colors"
                        style={{
            ...
            <div className="bg-white w-full max-w-md h-full shadow-2xl flex flex-col animate-in slide-in-from-right duration-200">
              ...
              >
                <div>
                  ...
                  <p className="text-xs text-white/80 mt-0.5">Initialize real estate infrastructure variables.</p>
                </div>
                <button 
              ...
              <form onSubmit={handleAddProperty} className="p-6 flex-1 overflow-y-auto space-y-5">
                <div>
                  ...
                  <input
                    ...
                    className="w-full border border-gray-200 rounded-lg px-3 py-2.5 outline-none text-sm transition focus:border-transparent"
                  />
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleInputChange}
                      className="w-full border border-gray-200 rounded-lg px-3 py-2.5 outline-none text-sm bg-white transition focus:border-transparent"
                    >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full border border-gray-200 rounded-lg px-3 py-2.5 outline-none text-sm transition resize-none focus:border-transparent"
                  ></textarea>
                </div>
                ...
                <div>
                  ...
                  <label className="border-2 border-dashed border-gray-300 rounded-xl h-40 flex flex-col items-center justify-center cursor-pointer hover:border-gray-400 transition">
                    <ImagePlus size={40} style={{ color: Colors.primary }} />
                ...
                <div className="pt-4 border-t border-gray-100 flex gap-3">
                  ...
                  <button
                    type="submit"
                    disabled={isSaving}
                    className="flex-1 text-white font-medium py-2.5 rounded-xl transition text-sm shadow-xs hover:opacity-90 disabled:opacity-50"
                    style={{ backgroundColor: Colors.primary }}
                  >
                    {isSaving ? (
