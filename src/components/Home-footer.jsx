      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
        ...
        <div className="col-span-2 space-y-4">
          <div className="flex items-center gap-2 group cursor-pointer w-max">
            <div 
              className="w-8 h-8 rounded-lg flex items-center justify-center font-black text-white text-base transition-transform duration-300 group-hover:rotate-12"
              style={{ backgroundColor: Colors.primary }}
            >
              U
            </div>
            <span 
              className="text-xl font-black text-white tracking-tight transition-colors duration-200"
            >
              UNIT
            </span>
          </div>
